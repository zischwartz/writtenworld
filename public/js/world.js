...
(function() {
  var Cell, cellKeyToXY, filter, getNodeIndex, initializeInterface, moveCursor, pan, panIfAppropriate, setTileStyle, switchToLayer, turnOffLayer, turnOffLayerHack, turnOnMainLayer,
    __slice = [].slice;
  ...
  initializeInterface = function() {
    ...
    map.on('viewreset', function(e) {
      ...
      if (map.getZoom() < config.minLayerZoom() && state.topLayer) {
        turnOffLayerHack();
      }
      if (map.getZoom() >= config.minLayerZoom() && !state.topLayer) {
  ...
  turnOffLayerHack = function() {
    Cell.killAll();
    state.topLayer = 0;
    return now.setCurrentWorld(null);
  };
