...
(function() {
  var Cell, cellKeyToXY, doNowInit, filter, getLayer, getNodeIndex, initializeInterface, moveCursor, pan, panIfAppropriate, removeLayerThenZoomOut, setTileStyle, switchToLayer, turnOffLayer, turnOnMainLayer,
    __slice = [].slice;
