...
(function() {
  var Cell, cellKeyToXY, filter, getLayer, getNodeIndex, initializeInterface, moveCursor, pan, panIfAppropriate, setTileStyle, switchToLayer, turnOffLayer, turnOffLayerHack, turnOnMainLayer,
    __slice = [].slice;
