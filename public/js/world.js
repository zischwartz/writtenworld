...
(function() {
  var Cell, cellKeyToXY, doNowInit, filter, getLayer, getNodeIndex, initializeInterface, moveCursor, pan, panIfAppropriate, removeLayerAndReplace, removeLayerThenZoomAndReplace, removeLayerThenZoomOut, setTileStyle, switchToLayer, turnOffLayer, turnOnMainLayer,
    __slice = [].slice;
  ...
  removeLayerAndReplace = function() {
    var $layer, canvasTiles, layer, stamp;
    Cell.killAll();
    layer = map._layers[state.topLayerStamp];
    $layer = $(".layer-" + state.topLayerStamp);
