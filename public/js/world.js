...
(function() {
  var Cell, cellKeyToXY, filter, getLayer, getNodeIndex, initializeInterface, moveCursor, pan, panIfAppropriate, setTileStyle, switchToLayer, turnOffLayer, turnOnMainLayer,
    __slice = [].slice;
