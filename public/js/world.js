...
(function() {
  var Cell, cellKeyToXY, filter, getLayer, getNodeIndex, initializeInterface, moveCursor, pan, panIfAppropriate, removeLayerThen, setTileStyle, switchToLayer, turnOffLayer, turnOnMainLayer,
    __slice = [].slice;
